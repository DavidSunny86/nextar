...
namespace nextar {
    ...
    public:
        /** @remarks Constructor **/
        inline ChunkInputStream(InputStreamPtr& o) : InputSerializer(o) { }
         ...
         */
        ChunkInputStream& ReadChunk(uint16 header, Chunk& read, const Chunk& prevChunk = ChunkInputStream::First);
    };
}
