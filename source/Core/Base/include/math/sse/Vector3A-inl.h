...
inline bool Vec3AGreaterAny(Vec4AF q1, Vec4AF q2) {
	return ((_mm_movemask_ps(_mm_cmpgt_ps(q1, q2))) & 0x7) != 0;
}

inline bool Vec3AGreaterAll(Vec4AF q1, Vec4AF q2) {
	return ((_mm_movemask_ps(_mm_cmpgt_ps(q1, q2)) & 0x7) == 0x7);
}

inline bool Vec3ALesserAny(Vec4AF q1, Vec4AF q2) {
	return Vec3AGreaterAny(q2, q1);
}

inline bool Vec3ALesserAll(Vec4AF q1, Vec4AF q2) {
