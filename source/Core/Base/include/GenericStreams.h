...
namespace nextar {
	 ...
	 * @date	11/29/2009
	 **/
	class _NexExport MemoryInputStream: public InputStream {
		uint8* data;
	 ...
	 * @date	11/29/2009
	 **/
	class _NexExport MemoryOutputStream: public OutputStream {
	...
	class _NexExport GenericInputStream: public InputStream {
	...
	class _NexExport GenericOutputStream: public OutputStream {
	...
	class _NexExport FileInputStream: public InputStream {
		std::FILE* streamptr;
	public:
	...
	class _NexExport FileOutputStream: public OutputStream {
		std::FILE* streamptr;
	public:
