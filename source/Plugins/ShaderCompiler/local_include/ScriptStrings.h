...
SCRIPT_STRING(CMD_MIN_FILTER, "min_filter");
SCRIPT_STRING(CMD_MAG_FILTER, "min_filter");
SCRIPT_STRING(CMD_ADDRESS_U, "address_u");
SCRIPT_STRING(CMD_ADDRESS_V, "address_v");
SCRIPT_STRING(CMD_ADDRESS_W, "address_w");
SCRIPT_STRING(CMD_ANISOTROPY, "anisotropy");
SCRIPT_STRING(CMD_MIN_LOD, "min_lod");
SCRIPT_STRING(CMD_MAX_LOD, "max_lod");
SCRIPT_STRING(CMD_LOD_BIAS, "lod_bias");
SCRIPT_STRING(CMD_BORDER_COLOR, "border_color");
...
SCRIPT_STRING(TAG_CONTEXT, "context");
// ## Regions
