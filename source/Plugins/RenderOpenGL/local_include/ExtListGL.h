...
/* GLE_4_3 */
DECL_COND_START_VERSION(GLV_4_3)
DECL_EXTENSION(DEBUGMESSAGECALLBACK, DebugMessageCallback)
DECL_EXTENSION(PUSHDEBUGGROUP, PushDebugGroup)
DECL_EXTENSION(POPDEBUGGROUP, PopDebugGroup)
DECL_COND_END_VERSION(GLV_4_3)
/* GLE_4_3 */
...
DECL_EXTENSION(COLORMASKI, ColorMaski)
DECL_EXTENSION(CLEARBUFFERFV, ClearBufferfv)
DECL_EXTENSION(CLEARBUFFERIV, ClearBufferiv)
DECL_EXTENSION(CLEARBUFFERFI, ClearBufferfi)
...
DECL_EXTENSION(BLENDEQUATIONI, BlendEquationi)
DECL_EXTENSION(BLENDEQUATIONSEPARATEI, BlendEquationSeparatei)
DECL_EXTENSION(BLENDFUNCI, BlendFunci)
DECL_EXTENSION(BLENDFUNCSEPARATEI, BlendFuncSeparatei)
