...
namespace RenderOpenGL {
	...
	RenderDriverGL::RenderDriverGL(int32 _gpuIndex) : gpuIndex(_gpuIndex) {
	}
    ...
    RenderContextPtr RenderDriverGL::CreateContextImpl(const RenderDriver::ContextCreationParams& params) {
